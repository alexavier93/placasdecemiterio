...
(function ($) {
  ...
  var formValidator = form.validate({
    ...
    messages: {
      size: {
        required: "Por favor, selecione um tamanho."
      },
      background: {
        required: "Por favor, selecione um fundo."
      },
      model: {
        required: "Por favor, selecione um modelo."
      },
      design: {
        required: "Por favor, selecione uma moldura."
      },
      fonte: {
        required: "Por favor, selecione uma fonte."
      },
      name: {
        required: "Por favor, digite um nome e sobrenome."
      },
      birthdate: {
        required: "Por favor, digite a data de nascimento."
      },
      deathdate: {
        required: "Por favor, digite a data de falecimento."
      },
      image: {
  ...
  $('.placaSteps').steps({
    ...
    onFinish: function onFinish(currentIndex) {
      form.submit();
    }
  });
  $('.cep').mask('00000-000');
...
__webpack_require__(/*! C:\xampp\htdocs\placasdecemiterio\resources\js\app.js */"./resources/js/app.js");
__webpack_require__(/*! C:\xampp\htdocs\placasdecemiterio\resources\sass\app.scss */"./resources/sass/app.scss");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\placasdecemiterio\resources\sass\admin\edit.scss */"./resources/sass/admin/edit.scss");
