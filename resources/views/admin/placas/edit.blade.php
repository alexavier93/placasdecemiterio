...
@section('content')
    ...
    <div class="page-header-content py-3">
        ...
        <ol class="breadcrumb mb-0 mt-4">
            ...
            <li class="breadcrumb-item active" aria-current="page">Editar Placa</li>
        </ol>
        ...
        <div class="col-xl-12 col-lg-12 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.placas.update', ['placa' => $placa->id]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ $placa->title }}">
                                @error('title')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="price" class="form-control money @error('price') is-invalid @enderror" value="{{ $placa->price }}" placeholder="R$ 00,00">
                                @error('price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="height" class="form-control cm @error('height') is-invalid @enderror" maxlength="6" value="{{ $placa->height }}" placeholder="0 cm">
                                @error('height')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="width" class="form-control cm @error('width') is-invalid @enderror" maxlength="6" value="{{ $placa->width }}" placeholder="0 cm">
                                @error('width')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="length" class="form-control cm @error('length') is-invalid @enderror" maxlength="6" value="{{ $placa->length }}" placeholder="0 cm">
                                @error('length')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="weight" class="form-control @error('weight') is-invalid @enderror" value="{{ $placa->weight }}" placeholder="0.300 g" data-mask="0.000">
                                @error('weight')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-sm-10">
                                <div class="multiple-checkbox row">
                                    @foreach ($modelos as $modelo)
                                        <div class="col-md-2">
                                            <input class="checkboxArray" type="checkbox" id="modelo-{{ $modelo->id }}" name="modelos[]" value="{{ $modelo->id }}" @if ($placa->modelos->contains($modelo)) checked @endif />
                                ...
                                <div class="multiple-checkbox row">
                                    ...
                                    <div class="col-md-2">
                                            <input class="checkboxArray" type="checkbox" id="moldura-{{ $moldura->id }}" name="molduras[]"
                                                value="{{ $moldura->id }}" {{ $placa->molduras->contains($moldura) ? 'checked' : '' }} />
                                ...
                                <div class="multiple-checkbox row">
                                    ...
                                    <div class="col-md-2">
                                            <input class="checkboxArray" type="checkbox" id="fundo-{{ $fundo->id }}" name="fundos[]"
                                                value="{{ $fundo->id }}" @if ($placa->fundos->contains($fundo)) checked @endif />
                                ...
                                <div class="multiple-checkbox row">
                                    ...
                                    <div class="col-md-4">
                                            <input class="checkboxArray" type="checkbox" id="fonte-{{ $fonte->id }}" name="fontes[]"
                                                value="{{ $fonte->id }}" @if ($placa->fontes->contains($fonte)) checked @endif />
